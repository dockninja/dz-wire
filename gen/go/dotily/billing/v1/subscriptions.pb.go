...
type Subscription struct {
	...
	SubscriptionId     string                 `protobuf:"bytes,5,opt,name=subscription_id,json=subscriptionId,proto3" json:"subscription_id,omitempty"` // external provider subscription id
	Status             SubscriptionStatus     `protobuf:"varint,6,opt,name=status,proto3,enum=dotily.billing.v1.SubscriptionStatus" json:"status,omitempty"`
	...
	TrialEnd           *timestamppb.Timestamp `protobuf:"bytes,12,opt,name=trial_end,json=trialEnd,proto3" json:"trial_end,omitempty"`
...
func (x *UpsertSubscriptionRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *UpsertSubscriptionRequest) GetPlanId() int64 {
	if x != nil {
		return x.PlanId
	}
	return 0
...
func (x *UpsertSubscriptionRequest) GetProvider() BillingProvider {
	if x != nil {
		return x.Provider
	}
	return BillingProvider_BILLING_PROVIDER_UNSPECIFIED
...
func (x *UpsertSubscriptionRequest) GetCurrentPeriodStart() *timestamppb.Timestamp {
	if x != nil {
		return x.CurrentPeriodStart
	}
	return nil
...
func (x *UpsertSubscriptionRequest) GetCurrentPeriodEnd() *timestamppb.Timestamp {
	if x != nil {
		return x.CurrentPeriodEnd
	}
	return nil
...
func (x *UpsertSubscriptionRequest) GetCancelAtPeriodEnd() bool {
	if x != nil {
		return x.CancelAtPeriodEnd
	}
	return false
...
func (x *UpsertSubscriptionRequest) GetCanceledAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CanceledAt
	}
	return nil
...
func (x *UpsertSubscriptionRequest) GetEndedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.EndedAt
	}
	return nil
...
func (x *UpsertSubscriptionRequest) GetTrialEnd() *timestamppb.Timestamp {
	if x != nil {
		return x.TrialEnd
	}
	return nil
...
func (x *UpsertSubscriptionResponse) GetSubscription() *Subscription {
	if x != nil {
...
const file_dotily_billing_v1_subscriptions_proto_rawDesc = "" +
	"\n" +
	"%dotily/billing/v1/subscriptions.proto\x12\x11dotily.billing.v1\x1a\x1fdotily/billing/v1/billing.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe4\x05\n" +
	"\fSubscription\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x17\n" +
	"\aplan_id\x18\x03 \x01(\x03R\x06planId\x12>\n" +
	"\bprovider\x18\x04 \x01(\x0e2\".dotily.billing.v1.BillingProviderR\bprovider\x12'\n" +
	"\x0fsubscription_id\x18\x05 \x01(\tR\x0esubscriptionId\x12=\n" +
	"\x06status\x18\x06 \x01(\x0e2%.dotily.billing.v1.SubscriptionStatusR\x06status\x12L\n" +
	...
	"canceledAt\x125\n" +
	"\bended_at\x18\v \x01(\v2\x1a.google.protobuf.TimestampR\aendedAt\x127\n" +
	"\ttrial_end\x18\f \x01(\v2\x1a.google.protobuf.TimestampR\btrialEnd\x129\n" +
	"\n" +
	"created_at\x18\r \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\x0e \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"\xeb\x04\n" +
	"\x19UpsertSubscriptionRequest\x12\x17\n" +
	...
	"\x06status\x18\x05 \x01(\x0e2%.dotily.billing.v1.SubscriptionStatusR\x06status\x12L\n" +
	...
	"canceledAt\x125\n" +
	"\bended_at\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\aendedAt\x127\n" +
	"\ttrial_end\x18\v \x01(\v2\x1a.google.protobuf.TimestampR\btrialEnd\"a\n" +
	"\x1aUpsertSubscriptionResponse\x12C\n" +
...
var file_dotily_billing_v1_subscriptions_proto_goTypes = []any{
	...
	(*UpsertSubscriptionRequest)(nil),  // 2: dotily.billing.v1.UpsertSubscriptionRequest
	(*UpsertSubscriptionResponse)(nil), // 3: dotily.billing.v1.UpsertSubscriptionResponse
...
var file_dotily_billing_v1_subscriptions_proto_depIdxs = []int32{
	...
	5,  // 7: dotily.billing.v1.Subscription.created_at:type_name -> google.protobuf.Timestamp
	5,  // 8: dotily.billing.v1.Subscription.updated_at:type_name -> google.protobuf.Timestamp
	4,  // 9: dotily.billing.v1.UpsertSubscriptionRequest.provider:type_name -> dotily.billing.v1.BillingProvider
	0,  // 10: dotily.billing.v1.UpsertSubscriptionRequest.status:type_name -> dotily.billing.v1.SubscriptionStatus
	5,  // 11: dotily.billing.v1.UpsertSubscriptionRequest.current_period_start:type_name -> google.protobuf.Timestamp
	5,  // 12: dotily.billing.v1.UpsertSubscriptionRequest.current_period_end:type_name -> google.protobuf.Timestamp
	5,  // 13: dotily.billing.v1.UpsertSubscriptionRequest.canceled_at:type_name -> google.protobuf.Timestamp
	5,  // 14: dotily.billing.v1.UpsertSubscriptionRequest.ended_at:type_name -> google.protobuf.Timestamp
	5,  // 15: dotily.billing.v1.UpsertSubscriptionRequest.trial_end:type_name -> google.protobuf.Timestamp
	1,  // 16: dotily.billing.v1.UpsertSubscriptionResponse.subscription:type_name -> dotily.billing.v1.Subscription
